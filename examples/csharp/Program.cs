...
class Program
{
    ...
    private const string Market = "NL";
    private const string Exchange = "EURONEXT";
    private const string Symbol = "EURONEXT:000040";
    ...
    static async Task StreamRealtime()
    {
        ...
        var subscribe = new
        {
            ...
            market = Market,
            exchange = Exchange,
            symbols = new[] { "EURONEXT:000040", "EURONEXT:005930" },
            replay = "last"
        };
