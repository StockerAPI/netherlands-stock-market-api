...
public class Main {
    ...
    private static final String MARKET = "NL";
    private static final String EXCHANGE = "EURONEXT";
    private static final String SYMBOL = "EURONEXT:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"EURONEXT:000040\",\"EURONEXT:005930\"],\"replay\":\"last\"}";
